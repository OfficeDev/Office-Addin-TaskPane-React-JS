/* global Word console */
export const insertWordText = async (text) => {
...
export const insertExcelText = async (text) => {
...
export const insertPowerPointText = async (text) => {
...
export const insertOutlookText = async (text) => {
